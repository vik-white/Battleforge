Shader "Custom/URPColoredShadowWithTransparency_ProjectedTexture"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag(Varyings IN) : SV_Target
            {
                ...
                // Смешиваем проекционную текстуру с итоговым цветом (просто умножаем по цвету, сохраняем alpha как есть)
